...
class getPreferencesController2Service extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Xnms9qc'] ?? $container->load('get_ServiceLocator_Xnms9qcService'))->withContext('PrestaShopBundle\\Controller\\Admin\\Improve\\Shipping\\PreferencesController', $container));
